export type ChainId = 'bitcoin' | 'solana' | 'xrp';
...
export interface WalletSnapshot { chain:ChainId; address:string; balance:{native:string; symbol:string; usd?:number}; transactions:WalletTransaction[]; received?:string; sent?:string; transactionCount?:number; pendingCount?:number; explorerUrl:string; }
